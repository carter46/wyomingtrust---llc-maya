<?php
/**
 * WyomingTrust inline SVG icons (replaces Material Symbols).
 * Usage: echo wt_icon('dashboard', 'w-5 h-5');
 */
...
function wt_icon_script_url(): string {
    return asset_url('assets/js/wt-icons.js');
}
