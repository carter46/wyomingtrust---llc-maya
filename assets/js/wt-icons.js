/**
 * WyomingTrust SVG icons for JavaScript-rendered UI.
 * Usage: wtIcon('dashboard', 'w-5 h-5')
 */
(function (global) {
    const PATHS = {
        dashboard: '<rect x="3" y="3" width="7" height="9" rx="1"/><rect x="14" y="3" width="7" height="5" rx="1"/><rect x="14" y="12" width="7" height="9" rx="1"/><rect x="3" y="16" width="7" height="5" rx="1"/>',
        gavel: '<path d="m14 4 6 6"/><path d="M4.5 19.5 9 15"/><path d="m9 9 6 6"/><path d="M3 21h6l8-8"/><path d="M16 3l5 5"/>',
        'add-circle': '<circle cx="12" cy="12" r="10"/><path d="M12 8v8M8 12h8"/>',
        ...
        'receipt-long': '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8M10 9H8"/>',
        ...
        receive: '<polyline points="17 11 12 6 7 11"/><line x1="12" y1="18" x2="12" y2="6"/>',
        swap: '<polyline points="17 1 21 5 17 9"/><path d="M3 5h18"/><polyline points="7 23 3 19 7 15"/><path d="M21 19H3"/>',
        ...
        'visibility-off': '<path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><line x1="1" y1="1" x2="23" y2="23"/>',
    ...
    const ALIASES = {
        ...
        groups: 'group',
        family_restroom: 'group',
        diversity_3: 'group',
        done: 'check-circle',
        shopping_cart: 'payments',
        auto_awesome: 'star',
        insights: 'info',
        support_agent: 'help',
        accessibility_new: 'help',
        shield_with_heart: 'shield',
        currency_bitcoin: 'wallet',
        edit_note: 'edit',
        smart_toy: 'link',
        business: 'group',
        compare: 'info',
    ...
    function setModalIcon(name, className) {
        ...
        if (!el) return;
        el.outerHTML = wtIcon(name, className).replace('<svg ', '<svg id="modalIcon" ');
    }

    global.wtIcon = wtIcon;
    global.setModalIcon = setModalIcon;
